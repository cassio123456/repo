...
{
    const char* pszTimestamp = "Much ooiho555f Saimyoji Temple in Japan was burned to the ground centuries ago, but its wall paintings are as vivid as ever";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1605994159,  77315, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb9d4f45b7c22e5a3757dd82858a22160847c64ef47eeb1f4c88e82ee44799f01"));
        assert(genesis.hashMerkleRoot == uint256S("0x283a7c42564ee7fd7a8282d3c9ceb6502fad259415ee8a2a781020c9aacaf3d5"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.emplace_back("dnsseed.faithco.in", true);
        //vSeeds.emplace_back("seed-a.bitcoinevelinn.loshan.co.uk", true);
        //vSeeds.emplace_back("dnsseed.thrasher.io", true);
        //vSeeds.emplace_back("dnsseed.bitcoinevelinntools.com", true);
        //vSeeds.emplace_back("dnsseed.bitcoinevelinnpool.org", true);
        ...
        checkpointData = (CCheckpointData) {
            {
                {  0, uint256S("0xb9d4f45b7c22e5a3757dd82858a22160847c64ef47eeb1f4c88e82ee44799f01")},
...
*/
        ...
        chainTxData = ChainTxData{
            ...
            1605994159, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.bitcoinevelinntools.com", true);
        vSeeds.emplace_back("seed-b.bitcoinevelinn.loshan.co.uk", true);
