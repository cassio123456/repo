...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinevelinn-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinevelinn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinevelinn transaction") + "\n" +
              "  bitcoinevelinn-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinevelinn transaction") + "\n" +
              "\n";
