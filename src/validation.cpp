...
#if defined(NDEBUG)
# error "bitcoinevelinn cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "bitcoinevelinn Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s BTEn additional fees, %d delta bytes\n",
